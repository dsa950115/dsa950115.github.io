...
My current research explores three directions through this lens: **Koopman operator methods** for control, the **linear representation hypothesis** for vision-language-action (VLA) models, and **kernel methods** for novelty detection.
