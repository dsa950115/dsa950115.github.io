...
I develop **structured representations for complex dynamical systems** that enable tractable learning, prediction, and control, with applications to Koopman models, vision-language-action (VLA) models, and world models. My research is grounded in **statistical learning theory**, particularly kernel methods and high-dimensional statistics, with additional interests in **uncertainty quantification and propagation**.
